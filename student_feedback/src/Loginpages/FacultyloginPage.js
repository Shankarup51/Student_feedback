    ...
    return(<div className="relative w-full h-screen  ">
        ...
        <div className=" absolute flex flex-col justify-center items-center top-0 left-0 right-0 bottom-0 ">
         ...
         <h1 className="text-black bg-yellow-400 text-center text-[30px] py-2 px-3 rounded-md mb-2 font-semibold ">
            ...
            <label className="text-zink-500 flex flex-col justify-center items-center text-[20px] w-full">Faculty Email-id :
                <input
        ...
        <label className="text-zink-500 flex flex-col justify-center items-center text-[20px] w-full relative"  >Faculty Password :
            <input
